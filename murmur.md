...
| 廠商 | 產品 | 做了什麼 | 蹭熱度等級 |
|------|------|----------|------------|
| **Kimi (月之暗面)** | **Kimi Claw** | 推出 **Kimi Claw Beta** (2026-02-16)，基於 OpenClaw 的雲端原生版，整合 Kimi k2.5 模型 | ⭐⭐⭐⭐⭐⭐ (官方下場！) |

> **點評**：這不是單純的託管，這是直接把 OpenClaw 變成自家產品的一部分了。Kimi 用戶可以直接在瀏覽器跑 Agent，還能橋接本地端。太狠了。
