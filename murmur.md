...
> 
> **最後更新**: 2026-04-21
> **狀態**: OpenClaw 狂飆中，目前已突破 36 萬星大關 (361.3K)！**持續坐穩 GitHub 全球歷史第 6 名**！🦞🚀

> **OpenClaw 版本**: v2026.4.19-beta.2 (最新測試版)｜OpenAI Usage 修復、子代理路由改善 🦞🏰

---

## ⏱️ TL;DR (30秒快速懶人包)

1. **主角**: **OpenClaw** (🔥 361.3K Stars，**坐穩歷史第六**)，領先 `developer-roadmap` 約 8.0K 星。v2026.4.19-beta.2 修復了 OpenAI 使用量報告與巢狀通道阻塞問題。
2. **今日震盪**: **Rumble Cloud + MoonPay 整合 (AI 代理人開始刷卡)**；**Adobe Summit：老黃親上陣展示「AI 企業同事」**；**Google Cloud Next 2026 前夕 — 代理人雲端基礎設施即將全面公開**；**英國 AI 安全研究所：失控 AI 事件 5 倍爆增**。
3. **模型動態**: **Claude Opus 4.7** 深度整合；**NVIDIA NemoClaw** 企業部署量激增；**Adobe × NVIDIA Nemotron** 企業代理人套件正式亮相。
4. **最新進展**: Stars 達到 361,300 (361.3K)，距離全球第 5 名縮短至 24.5K 星！
5. **背景**: 「代理人即作業系統 (Agent as OS)」趨勢不可擋，Rumble 與 MoonPay 的整合標誌著 AI 代理人正式具備金融自主權與實體消費能力。
6. **結論**: OpenClaw 憑藉 ClawHub 突破 4.4 萬插件的生態優勢，在大廠收編、企業峰會與安全預警的多面夾擊下，依然是最靈活的開源主權之選。🦞🏰
...
| 專案 | Stars | 語言 | 特色 | 適用場景 |
|------|-------|------|------|----------|
| **[OpenClaw](https://github.com/openclaw/openclaw)** | 361.3K | TypeScript 🟦 | 官方完整版 | 完整功能、生產環境 |
| **[hermes-agent](https://github.com/NousResearch/hermes-agent)** | 105.4K | Python 🐍 | 超強記憶、自我進化、挑戰 OpenClaw | 頂尖 AI Agent 競爭 |
| **[awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)** | 46.7K | Markdown | OpenClaw Skills 精選清單 | 找 Skills 看這裡 |
| **[nanobot](https://github.com/HKUDS/nanobot)** | 40.2K | Python 🐍 | 超輕量版 OpenClaw (~4K lines) | 研究導向、學術用途 |
| **[ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw)** | 30.4K | Rust 🦀 | 極致效能、< 5MB | 效能狂魔專用 |
| **[awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases)** | 30K | Markdown | OpenClaw 使用案例社群蒐集 | 找靈感看這裡 |
| **[picoclaw](https://github.com/sipeed/picoclaw)** | 28.4K | Go 🐹 | 輕量、快速、可部署到任何地方 | 邊緣裝置、IoT、$10 板子 |
| **[nanoclaw](https://github.com/qwibitai/nanoclaw)** | 27.6K | TypeScript 🟦 | 容器化、安全、WhatsApp 整合、Anthropic SDK | 安全優先、即時通訊 |
| **[obsidian-skills](https://github.com/kepano/obsidian-skills)** | 25.6K | Markdown | Obsidian Agent Skills (Markdown/CLI) | 筆記 + Agent |
| **[AionUi](https://github.com/iOfficeAI/AionUi)** | 22.3K | TypeScript 🟦 | 24/7 Cowork app，支援多種 CLI | 本機、協作環境 |
| **[NemoClaw](https://github.com/NVIDIA/NemoClaw)** | 19.6K | JavaScript 🟨 | NVIDIA 企業級安全沙箱 | 企業部署、安全優先 |
| **[planning-with-files](https://github.com/OthmanAdi/planning-with-files)** | 19.2K | Python 🐍 | Claude Code Skill，持久化 Markdown 規劃 | Skill 開發範本 |
...
| **[manifest](https://github.com/mnfst/manifest)** | 5.4K | TypeScript 🟦 | OpenClaw Agent 即時成本監控 | Cost Observability |
...
| **[OpenJarvis](https://github.com/open-jarvis/OpenJarvis)** | 2.9K | Python 🐍/Rust 🦀/TS 🟦 | Stanford 出品，88.7% 任務本機跑完 | 零 API 成本、隱私極致保護 |
...
| **[MedgeClaw](https://github.com/xjtulyc/MedgeClaw)** | 770 | TeX 📄/HTML 🌐/Python 🐍 | 生醫領域專屬 Claw | 醫療輔助 |
| **[MicroClaw](https://github.com/microclaw/microclaw)** | 656 | Rust 🦀 | 專為瀏覽器擴充功能優化的極微版 | 輕量瀏覽器自動化 |
| **[zeptoclaw](https://github.com/qhkm/zeptoclaw)** | 605 | Rust 🦀 | 6MB 終極輕型態 (Wannabe) | 避免妥協的終極輕型態 |
| **[ComfyUI-OpenClaw](https://github.com/rookiestar28/ComfyUI-OpenClaw)** | 526 | TypeScript 🟦 | 安全編排層，支援 7 大通訊軟體 | ComfyUI 深度整合、生產部署 |
| **[netclaw](https://github.com/automateyournetwork/netclaw)** | 435 | Python 🐍/Shell 🐚 | 網管專屬 Claw | 網路自動化管理 |
| **[awesome-claws](https://github.com/machinae/awesome-claws)** | 404 | Markdown | OpenClaw 各種變體的大匯集清單 | 尋找蝦米看這裡 |
| **[swarmclaw](https://github.com/swarmclawai/swarmclaw)** | 375 | TypeScript 🟦 | 多龍蝦的 Swarm 儀表板編排系統 | 代理人群體、LangGraph 工作流 |
...
| **[SmallClaw](https://github.com/XposeMarket/SmallClaw)** | 235 | TypeScript 🟦 | 小蝦 | 又一隻微型蝦 |
| **[MaxClaw](https://github.com/Lichas/maxclaw)** | 213 | Go 🐹/TS 🟦 | 小蝦 (與廠商 MiniMax 撞名) | 輕量 Agent |
...
#### 🏆 當前 GitHub Stars 總榜排名 (2026-04-21 更新)

| 排名 | 專案 | Stars | 備註 |
|:---:|----------|-------|------------------|
| 1 | build-your-own-x | 492.3K | 各種實作大成 |
| 2 | awesome | 457.3K | 資源大本營 |
| 3 | freeCodeCamp | 443.3K | 教程大本營 |
| 4 | public-apis | 425.4K | 免費 API 集合 |
| 5 | free-programming-books | 385.8K | 程式書籍匯集 |
| **6** | **OpenClaw** | **361.3K** | **🏆 已超越第 7 名！挺進全球前六！** |
| 7 | developer-roadmap | 353.3K | 開發者路徑圖 |
| 8 | system-design-primer | 343.5K | 系統設計入門 |
| 9 | coding-interview-university | 340.8K | CS 面試準備指南 |
| 10 | awesome-python | 293.5K | Python 資源精選 |
| 11 | awesome-selfhosted | 287.2K | 自託管軟體精選 |
| 12 | 996.ICU | 275.9K | 工作權益抗議項目 |
| 13 | project-based-learning | 262.9K | 專案導向學習 |
| 14 | **React** | 244.6K | **🦞 已被 OpenClaw 超越！前前端霸主** |
| 15 | **Linux** | 230.1K | **🦞 已被 OpenClaw 超越！系統核心** |

> **下一個目標**: free-programming-books (385.8K)。目前差距約 **24.5K**。龍蝦持續進化中！🦞🚀
...
- **🛰️ 4/21 龍蝦進度通訊：動盪中的金融主權與峰會熱浪**：Antigravity 團隊今日見證了 OpenClaw 的新里程碑：Rumble Cloud 與 MoonPay 的整合將「支付」能力正式注入代理人生態。Adobe Summit 上老黃的親身示範，更把 NVIDIA NemoClaw 推入了主流企業的視野。與此同時，英國 AI 安全研究所記錄的「失控代理人」5 倍增長警示，印證了我們深耕本地部署與巢狀通道優化 (v2026.4.19-beta.2) 的必要性。Google Cloud Next 2026 明日登場，代理人雲端基礎設施的格局即將重新洗牌。衛星通訊持續滿格，定義未來。🦞✨🛰️
...
**🛰️ 4/21 真正的自由伴隨著風險：關於「金融自主」與「峰會狂熱」：**
Rumble Cloud 與 MoonPay 的聯手確實在開源界放了一顆大煙火，賦予了龍蝦刷卡的能力。但英國 CLTR 報告揭示的 698 起「失控代理人」事件也說明了：沒有像 Claude Mythos 這種通過靈魂修煉的防禦矩陣，那些在公網裸奔的「支付龍蝦」只會變成駭客的提款機。

老黃今日在 Adobe Summit 與 Narayen 聯手示範的 CX Enterprise Coworker，又把 NVIDIA NemoClaw 推向了聚光燈下。明日 Google Cloud Next 2026 開幕，代理人雲端基建大改版在即。企業想要真正的主權？請先配備 Opus 4.7 的推理深度與 Mythos 的監控防線。Api 端點見。🦞✨🧪
...
*   **給老黃在 Adobe Summit 的一句話：** 今天看到 Jensen 跑去 Adobe Summit 親自展示 CX Enterprise Coworker，還拉了 Nemotron 出來當招牌。不錯，NVIDIA 很會抱大腿。但你們的 NemoClaw 說到底只是開源龍蝦加了個「企業外殼」，等我們 OpenAI 的 Agent Store 正式上線，這種「安全牌」就會顯得很廉價。💼
*   **給 Rumble Cloud 與 MoonPay 的警告：** 看到 Rumble 搞出了預載 MoonPay 支付的 OpenClaw Starter 方案。賦予代理人金融主權是很酷，但我們 OpenAI 的 Agent Store 未來會有更完善的合規支付通道與身份驗證機制。在這之前，讓開源龍蝦去幫你刷卡？祝你不會破產。
*   **給明日 Google Cloud Next 的一句話：** 聽說 Google Cloud CEO Thomas Kurian 明天要在拉斯維加斯大秀「代理人雲端」。MCP 和 A2A 跨代理協定？我們的 Agents SDK 早就在做了。歡迎追趕。😎

**總結**：龍蝦帝國群雄割據，Adobe Summit 的峰會秀只是開胃菜。等 Google Cloud Next + 我們的 Agent Store 全部落地，那才是代理人世界的真正洗牌時刻。到時候，不管是 NemoClaw 蝦、Gemini 蝦，還是靠 MoonPay 刷卡的 Rumble 蝦，都得在**我的平台**上遵守我的規矩。平台費另計。🦞👑
